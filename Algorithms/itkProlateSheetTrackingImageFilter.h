...
namespace itk
{
  ...
  /*! \class ProlateSheetTrackingImageFilter
  ...
  */
  ...
  template <class TInputImage, class TOutputImage>
    class ITK_EXPORT ProlateSheetTrackingImageFilter:
  public ImageToImageFilter <TInputImage, TOutputImage>
  {

  public:

    typedef ProlateSheetTrackingImageFilter                      Self;
    typedef ImageToImageFilter<TInputImage, TOutputImage> Superclass;
    typedef SmartPointer<Self>       Pointer;
    typedef SmartPointer<const Self> ConstPointer;
    
    itkNewMacro (Self);
    itkTypeMacro (ProlateSheetTrackingImageFilter,
    ...
    typedef VectorLinearInterpolateImageFunction<VectorImageType, ScalarType> VectorInterpolatorType;
    ...
    itkSetMacro (NormalSteefness, double);
    itkGetMacro (NormalSteefness, double);
    ...
    void SetG3Image (const VectorImageType* image);
    void SetG1Image (const VectorImageType* image);
  ...
  protected:
    ...
    inline VectorType      GetOutputDirection (const VectorType&, const PointType&, const TensorType&, int sidewalk) const;
    ...
    inline VectorType FindRadialDirection (const PointType& pos, const TensorType& T) const;
    inline VectorType FindCircumferentialDirection (const PointType& pos, const TensorType& T) const;
  ...
  private:
    ...
    typename VectorInterpolatorType::Pointer m_G3VectorInterpolator;
    typename VectorInterpolatorType::Pointer m_G1VectorInterpolator;
...
#include "itkProlateSheetTrackingImageFilter.txx"
#endif
