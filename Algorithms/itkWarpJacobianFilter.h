...
=========================================================================*/
#ifndef __itkWarpJacobianFilter_h
#define __itkWarpJacobianFilter_h
...
public:
  ...
  typedef WarpJacobianFilter Self;
  ...
  itkTypeMacro(WarpJacobianFilter, ImageToImageFilter);
...
protected:
  ...
  /** WarpJacobianFilter can be implemented as a
...
private:
  ...
  WarpJacobianFilter(const Self&); //purposely not implemented
...
#include "itkWarpJacobianFilter.txx"
#endif
