/*=========================================================================
  ...
  Module:    $URL: https://scm.gforge.inria.fr/svn/ttk/trunk/Commands/itkAddGaussianNoiseToImageCommand.cxx $
  Language:  C++
...
namespace itk
{
  ...
  AddGaussianNoiseToImageCommand::AddGaussianNoiseToImageCommand()
  {
    m_ShortDescription = "Add Gaussian noise to an image";
  ...
  int AddGaussianNoiseToImageCommand::Execute (int narg, const char* arg[])
  {
