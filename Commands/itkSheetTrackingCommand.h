...
namespace itk {
  ...
  */
  ...
  class SheetTrackingCommand : public CommandObjectBase
  {
    
  public:
		
    typedef SheetTrackingCommand Self;
    ...
    itkTypeMacro(SheetTrackingCommand, CommandObjectBase);
    itkNewMacro(Self);
    
    const char *GetCommandName(void)
    { return "sheet_tractography"; }
    
    int Execute(int nargs, const char *args[]);
    
  protected:
    SheetTrackingCommand();
    ~SheetTrackingCommand();
    
  private:
    SheetTrackingCommand(const Self&);
