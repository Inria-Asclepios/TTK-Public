...
=========================================================================*/
#ifndef __itkMultiResolutionPyramidTensorImageFilter_h
#define __itkMultiResolutionPyramidTensorImageFilter_h
...
/** \class MultiResolutionPyramidTensorImageFilter
 * \brief Framework for creating tensor images in a multi-resolution
 * pyramid.
 *
 * MultiResolutionPyramidTensorImageFilter provides a generic framework to
 * to create a image pryamid according to a user defined
 * multi-resolution schedule. It is heavily based on
 * MultiResolutionPyramidImageFilter, with modifications to handle tensor
 * images.
 *
...
template <
  ...
  class TOutputImage
  >
class ITK_EXPORT MultiResolutionPyramidTensorImageFilter :
    public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef MultiResolutionPyramidTensorImageFilter  Self;
  ...
  itkTypeMacro(MultiResolutionPyramidTensorImageFilter, ImageToImageFilter);
  ...
  /** MultiResolutionPyramidTensorImageFilter produces images which are of
   * different resolution and different pixel spacing than its input image.
   * As such, MultiResolutionPyramidTensorImageFilter needs to provide an
  ...
  /** MultiResolutionPyramidTensorImageFilter requires a larger input requested
   * region than the output requested regions to accomdate the shrinkage and
   * smoothing operations. As such, MultiResolutionPyramidTensorImageFilter needs
...
#endif
protected:
  MultiResolutionPyramidTensorImageFilter();
  ~MultiResolutionPyramidTensorImageFilter() {};
...
private:
  MultiResolutionPyramidTensorImageFilter(const Self&); //purposely not implemented
...
#include "itkMultiResolutionPyramidTensorImageFilter.txx"
#endif
