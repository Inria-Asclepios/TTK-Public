...
# The "use" file.
SET(IPF_USE_FILE ${IPF_INSTALL_PREFIX}/lib/UseIPF.cmake)

# The build settings file.
SET(IPF_BUILD_SETTINGS_FILE ${IPF_INSTALL_PREFIX}/lib/IPFBuildSettings.cmake)

# Include directories.
SET(IPF_INCLUDE_DIRS_CONFIG
  ${IPF_INSTALL_PREFIX}/include
  ${IPF_INCLUDE_DIRS_SYSTEM}
)
...
IF(CYGWIN AND BUILD_SHARED_LIBS)
  ...
  SET(IPF_LIBRARY_DIRS_CONFIG ${IPF_INSTALL_PREFIX}/bin/)
ELSE(CYGWIN AND BUILD_SHARED_LIBS)
  SET(IPF_LIBRARY_DIRS_CONFIG ${IPF_INSTALL_PREFIX}/lib/)
ENDIF(CYGWIN AND BUILD_SHARED_LIBS)

# Runtime directories.
IF(WIN32)
  SET(IPF_RUNTIME_LIBRARY_DIRS_CONFIG ${IPF_INSTALL_PREFIX}/bin/)
ELSE(WIN32)
  SET(IPF_RUNTIME_LIBRARY_DIRS_CONFIG ${IPF_INSTALL_PREFIX}/lib/)
ENDIF(WIN32)
