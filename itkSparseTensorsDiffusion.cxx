...
void PrintHelp(const char* exec)
{
  ...
  std::cout << "-i    [Input Tensor Image]" << std::endl;
  std::cout << "-tens [vtkUnstructuredGrid File]" << std::endl;
  std::cout << "-tan  [Release tangent information 0/1]" << std::endl;
  std::cout << "-s    [Sigma Diffusion]" << std::endl;
  std::cout << "-l    [Lambda = amount of data attach]" << std::endl;
  std::cout << "-dt   [Delta T]" << std::endl;
  std::cout << "-nite [Number of Iterations]" << std::endl;  
  std::cout << "-rms  [RMS]" << std::endl;
  std::cout << "-t    [Threads]" << std::endl;  
  std::cout << "-o    [Structured Tensor Output]" << std::endl;
  exit(0);
