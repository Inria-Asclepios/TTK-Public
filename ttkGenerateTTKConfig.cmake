...
# The "use" file.
SET(TTK_USE_FILE ${TTK_INSTALL_PREFIX}/lib/UseTTK.cmake)

# The build settings file.
SET(TTK_BUILD_SETTINGS_FILE ${TTK_INSTALL_PREFIX}/lib/TTKBuildSettings.cmake)

# Include directories.
SET(TTK_INCLUDE_DIRS_CONFIG
  ${TTK_INSTALL_PREFIX}/include
  ${TTK_INCLUDE_DIRS_SYSTEM}
)
...
IF(CYGWIN AND BUILD_SHARED_LIBS)
  ...
  SET(TTK_LIBRARY_DIRS_CONFIG ${TTK_INSTALL_PREFIX}/bin/)
ELSE(CYGWIN AND BUILD_SHARED_LIBS)
  SET(TTK_LIBRARY_DIRS_CONFIG ${TTK_INSTALL_PREFIX}/lib/)
ENDIF(CYGWIN AND BUILD_SHARED_LIBS)

# Runtime directories.
IF(WIN32)
  SET(TTK_RUNTIME_LIBRARY_DIRS_CONFIG ${TTK_INSTALL_PREFIX}/bin/)
ELSE(WIN32)
  SET(TTK_RUNTIME_LIBRARY_DIRS_CONFIG ${TTK_INSTALL_PREFIX}/lib/)
ENDIF(WIN32)
